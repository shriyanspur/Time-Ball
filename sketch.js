...
function draw() {
  ...
  console.log(l1g.maxDepth());
  console.log(aloo.depth);
...
if (level == 3) {
  ...
  if (lives == 0){
    ...
    aloo.x = random(20, displayWidth-20);
    aloo.y = random(-2200, -2700);
    aloo.visibility = false;
    aloo.velocityY = 0;

    aloo2.x = random(20, displayWidth-20);
    aloo2.y = random(-2200, -2700);
    aloo2.velocityY = 0;

    aloo3.x = random(20, displayWidth-20);
    aloo3.y = random(-2200, -2700);
    aloo3.velocityY = 0;
    ...
    l1g.setVisibleEach(false);
    l2g.setVisibleEach(false);
    l3g.setVisibleEach(false);
    ...
    if(mousePressedOver(restart)){
      ...
      if(level == 2 && counter == 58){
        level2();
      }

      if(level == 3 && counter == 80){
        level3();
      }
      ...
      //l1g.setDepthEach(10);
      /*l2g.setDepthEach(301);
      l3g.setDepthEach(302);*/
    }
  
    //console.log(ba1.depth);
